		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Timesheet",
									"targetURL": "#hcmfabmytimesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hcmfabmytimesheet-display": {
								"semanticObject": "hcmfabmytimesheet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hcm.fab.mytimesheet",
									"url": sap.ui.require.toUrl("hcm/fab/mytimesheet")
								}
							}
						}
					}
